# BASS-HI Project
** This is a BASS-HI project github repository. The BASS-HI project is the HI imaging survey of the BAT AGN Spectroscopic Survey ([BASS](https://www.bass-survey.com/)).**
...
BASS-HI is the largest HI imaging survey of AGN host galaxies, based on the BASS survey.

This survey is based on VLA C- and D-configuration observations of 40 northern targets, along with ATCA observations of 8 southern targets. In addition, archival data of matching quality from VLA, GMRT, WSRT, and ATCA were incorporated, resulting in a final sample of approximately 100 BASS-HI galaxies.

With this beautiful dataset, we will provide... 




The BASS-HI data are planned for public release in 2027 — stay tuned for interesting science updates!
[I wanna subscribe](https://buttondown.com/jikim/archive/welcome-bass-hi-data-coming-soon-2835/)
